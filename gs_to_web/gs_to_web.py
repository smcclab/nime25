...
proc_cols = ["id","track","format","type","session_code","session_name","session_position","duration","presence","speaker","title","authors","abstract","paper_url","video_url","slides_url","image_url","image_credit"]
